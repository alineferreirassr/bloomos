...
- [ ] Build Events module, then wire its card into the Dashboard — foundation + generalized architecture done on `feature/events` (types/enums/workflow/data layer/health score/checklist templates, no UI yet); pages/components still pending
