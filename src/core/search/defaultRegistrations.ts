 ...
 * those modules existing (see `core/enums/entityType.ts`'s "inventory"/
...
export function registerDefaultSearchableEntities(): void {
  ...
  // Reserved — no route until these modules ship (see entityType.ts's comment on "inventory"/"vendor").
