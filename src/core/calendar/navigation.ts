...
/** Moves the anchor date forward by exactly one unit of `view` — a month advances by calendar month (so it lands on the 1st regardless of today's day-of-month), a week/day by a fixed 7/1-day offset. */
