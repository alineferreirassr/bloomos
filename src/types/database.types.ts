...
export interface Database {
  public: {
    Tables: {
      ...
      gmail_mailboxes: {
        Row: { id: string; workspace_id: string; member_id: string; integration_connection_id: string; provider_account_id: string | null; email_address: string | null; display_name: string | null; history_id: string | null; sync_status: string; last_synced_at: string | null; last_successful_sync_at: string | null; sync_error_code: string | null; created_at: string; updated_at: string };
        Insert: { id?: string; workspace_id: string; member_id: string; integration_connection_id: string; provider_account_id?: string | null; email_address?: string | null; display_name?: string | null; history_id?: string | null; sync_status?: string; last_synced_at?: string | null; last_successful_sync_at?: string | null; sync_error_code?: string | null; created_at?: string; updated_at?: string };
        Update: { id?: string; workspace_id?: string; member_id?: string; integration_connection_id?: string; provider_account_id?: string | null; email_address?: string | null; display_name?: string | null; history_id?: string | null; sync_status?: string; last_synced_at?: string | null; last_successful_sync_at?: string | null; sync_error_code?: string | null; created_at?: string; updated_at?: string };
        Relationships: [];
      };
      gmail_threads: {
        Row: { id: string; workspace_id: string; member_id: string; mailbox_id: string; provider_thread_id: string; subject: string | null; snippet: string | null; latest_message_at: string | null; message_count: number; unread_count: number; created_at: string; updated_at: string };
        Insert: { id?: string; workspace_id: string; member_id: string; mailbox_id: string; provider_thread_id: string; subject?: string | null; snippet?: string | null; latest_message_at?: string | null; message_count?: number; unread_count?: number; created_at?: string; updated_at?: string };
        Update: { id?: string; workspace_id?: string; member_id?: string; mailbox_id?: string; provider_thread_id?: string; subject?: string | null; snippet?: string | null; latest_message_at?: string | null; message_count?: number; unread_count?: number; created_at?: string; updated_at?: string };
        Relationships: [];
      };
      gmail_messages: {
      ...
      google_calendar_events: {
        Row: { id: string; workspace_id: string; member_id: string; calendar_id: string; provider_event_id: string; i_cal_uid: string | null; recurring_event_id: string | null; original_start_time: string | null; summary: string | null; description: string | null; location: string | null; status: string | null; all_day: boolean; start_date: string | null; end_date: string | null; start_date_time: string | null; end_date_time: string | null; time_zone: string | null; organizer: Record<string, unknown> | null; attendees: Record<string, unknown>[]; html_link: string | null; hangout_link: string | null; cancelled_at: string | null; created_at: string; updated_at: string };
        Insert: { id?: string; workspace_id: string; member_id: string; calendar_id: string; provider_event_id: string; i_cal_uid?: string | null; recurring_event_id?: string | null; original_start_time?: string | null; summary?: string | null; description?: string | null; location?: string | null; status?: string | null; all_day?: boolean; start_date?: string | null; end_date?: string | null; start_date_time?: string | null; end_date_time?: string | null; time_zone?: string | null; organizer?: Record<string, unknown> | null; attendees?: Record<string, unknown>[]; html_link?: string | null; hangout_link?: string | null; cancelled_at?: string | null; created_at?: string; updated_at?: string };
        Update: { id?: string; workspace_id?: string; member_id?: string; calendar_id?: string; provider_event_id?: string; i_cal_uid?: string | null; recurring_event_id?: string | null; original_start_time?: string | null; summary?: string | null; description?: string | null; location?: string | null; status?: string | null; all_day?: boolean; start_date?: string | null; end_date?: string | null; start_date_time?: string | null; end_date_time?: string | null; time_zone?: string | null; organizer?: Record<string, unknown> | null; attendees?: Record<string, unknown>[]; html_link?: string | null; hangout_link?: string | null; cancelled_at?: string | null; created_at?: string; updated_at?: string };
        Relationships: [];
      };
