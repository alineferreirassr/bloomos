...
// non-CRM) search/filter/form input already consumes it.
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  return (
    <input
      ...
      className={`w-full h-10 rounded-md border bg-surface px-3 py-2 text-sm text-text transition-colors duration-150 placeholder:text-text-muted hover:border-text/45 focus-visible:border-accent disabled:cursor-not-allowed disabled:opacity-55 ${
