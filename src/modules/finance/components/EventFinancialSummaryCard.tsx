 ...
 * computeEventFinancialSummary/getEventFinancialStatus (lib/data/index.ts's
 * getEventFinancialSummary/getEventFinancialStatus), never recomputed here.
 * "Create Invoice" passes both eventId and clientId — the Invoice form's
 * Event dropdown only populates once a Client is selected, so eventId alone
 * wouldn't visibly prefill anything.
 */
